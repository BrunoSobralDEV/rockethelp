...
import { CircleWavyCheck, Hourglass, DesktopTower, ClipboardText, CircleWavy } from 'phosphor-react-native';
...
export function Details() {
  ...
  function handleOrderClose() {
    if(!solution) {
      return Alert.alert('Solicitação', 'Informe a solução para ser encerrada');
    }
